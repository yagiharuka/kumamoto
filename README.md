...
熊本地震に関する「イオン爆発」「停電・電源車」
「日本製紙・八代工場」の報道を、
国内主要紙・NHK・熊本日日新聞・時事通信から集約するサイトです。

- 公開ページ: <https://yagiharuka.github.io/kumamoto/>
- 更新: Cloudflare Cronから30分ごと（GitHub Actionsによる遅延検知・補完あり）
- カテゴリ: イオン爆発、停電・電源車、日本製紙・八代工場
...
Cloudflareは毎時00分・30分に通常更新を起動します。GitHub Actionsは
毎時10分・40分に、担当する直前の00分・30分枠が更新済みかを確認し、
その枠が欠けている場合だけ補完更新を行います。GitHub側の起動が遅れても、
経過時間ではなく対象枠で判定します。RSSが全面的に応答しない場合は、
間隔を空けて最大3回再試行します。
